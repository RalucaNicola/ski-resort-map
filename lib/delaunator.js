!(function(i, t) {
  ...
  var i = Math.pow(2, -52),
    ...
    r = function(i) {
      ...
      (this._triangles = new Uint32Array(3 * r)),
        (this._halfedges = new Int32Array(3 * r)),
  ...
  function n(i, t, r, s) {
    if (s - r <= 20)
      ...
      (i[r + 1] = i[_]),
        (i[_] = d),
        s - f + 1 >= _ - r ? (n(i, t, f, s), n(i, t, r, _ - 1)) : (n(i, t, r, _ - 1), n(i, t, f, s));
    }
  }
  function l(i, t, r) {
    var s = i[t];
  ...
  return (
    ...
    (r.prototype.update = function() {
      ...
      var Q = (function(i, t, r, s, h, a) {
        var e = r - i,
          ...
          _ = l * l + o * o,
          d = 0.5 / (e * o - n * l);
        return { x: i + (o * f - n * _) * d, y: t + (e * _ - l * f) * d };
      })(z, U, K, L, H, I);
      ...
      (h[w] = r[b] = p),
        ...
        (l[b] = 2),
        o.fill(-1),
        (o[this._hashKey(z, U)] = w),
        (o[this._hashKey(K, L)] = p),
        (o[this._hashKey(H, I)] = b),
        (this.trianglesLen = 0),
        this._addTriangle(w, p, b, -1, -1, -1);
      for (var W = 0, X = void 0, Y = void 0; W < this._ids.length; W++) {
        var Z = this._ids[W],
          $ = t[2 * Z],
          ii = t[2 * Z + 1];
        if (
          !(W > 0 && Math.abs($ - X) <= i && Math.abs(ii - Y) <= i) &&
          ((X = $), (Y = ii), Z !== w && Z !== p && Z !== b)
        ) {
          for (
            var ti = 0, ri = 0, si = this._hashKey($, ii);
            ri < this._hashSize && (-1 === (ti = o[(si + ri) % this._hashSize]) || ti === h[ti]);
            ri++
          );
          for (
            var hi = (ti = r[ti]), ai = void 0;
            (ai = h[hi]), !a($, ii, t[2 * hi], t[2 * hi + 1], t[2 * ai], t[2 * ai + 1]);
          ...
          if (-1 !== hi) {
            ...
            for (var ni = h[hi]; (ai = h[ni]), a($, ii, t[2 * ni], t[2 * ni + 1], t[2 * ai], t[2 * ai + 1]); )
              (ei = this._addTriangle(ni, Z, ai, l[Z], -1, l[ni])),
                (l[Z] = this._legalize(ei + 2)),
                (h[ni] = ni),
                V--,
                (ni = ai);
            if (hi === ti)
              for (; a($, ii, t[2 * (ai = r[hi])], t[2 * ai + 1], t[2 * hi], t[2 * hi + 1]); )
                (ei = this._addTriangle(ai, Z, hi, -1, l[hi], l[ai])),
                  this._legalize(ei + 2),
                  (l[ai] = ei),
                  (h[hi] = hi),
                  V--,
                  (hi = ai);
            (this._hullStart = r[Z] = hi),
              (h[hi] = r[ni] = Z),
              (h[Z] = ni),
              (o[this._hashKey($, ii)] = Z),
              (o[this._hashKey(t[2 * hi], t[2 * hi + 1])] = hi);
          }
        }
      }
    ...
    (r.prototype._hashKey = function(i, t) {
      return (
        Math.floor(
          ((r = i - this._cx),
          (s = t - this._cy),
          (h = r / (Math.abs(r) + Math.abs(s))),
          ((s > 0 ? 3 - h : 1 + h) / 4) * this._hashSize)
        ) % this._hashSize
      );
      var r, s, h;
    }),
      ...
      for (
        ...
        if (((k = M + ((i + 2) % 3)), -1 !== x)) {
          ...
          if (
            ...
            (g = void 0),
            (c = void 0),
            (f = r - l) * ((v = a - o) * (c = (u = e - l) * u + (y = n - o) * y) - (g = (d = h - l) * d + v * v) * y) -
              (_ = s - o) * (d * c - g * u) +
              (f * f + _ * _) * (d * y - v * u) <
              0)
          ) {
    ...
    (r.prototype._addTriangle = function(i, t, r, s, h, a) {
      ...
      return (
        (this._triangles[e] = i),
        (this._triangles[e + 1] = t),
        (this._triangles[e + 2] = r),
        this._link(e, s),
        this._link(e + 1, h),
        this._link(e + 2, a),
        (this.trianglesLen += 3),
